...
public class MailService {
    ...
    public void sendVerificationEmail(User user) throws MessagingException, UnsupportedEncodingException{
        ...
        String fromAddress = "stefanymikaellesud@gmail.com";
        String senderName = "Stefany Mãe DEV";
        String subject = "Please  verify our registration";
        ...
        // Usa um helper para configurar a mensagem de email
        MimeMessageHelper mimeMessageHelper = new MimeMessageHelper(mimeMessage);

        // Define o remetente e o nome do remetente
        ...
        // Substitui placeholders no conteúdo do email com informações do usuário
        content = content.replace("[[NAME]]", user.getName());
        String verifyURL = this.verifyURL + user.getVerificationCode();
        content = content.replace("[[URL]]", verifyURL);

        // Define o conteúdo do email (pode ser HTML)
